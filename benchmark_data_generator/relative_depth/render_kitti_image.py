...
if __name__ == "__main__":
    seed = 1234
    subset_size = 1000
    base_path_rgb = 'kitti_%d_rgb' % subset_size
    base_path_raw = 'kitti_%d_raw' % subset_size
    base_path_meta = 'kitti_%d_meta' % subset_size
    ...
    tgt_dataset = KITTI('kitti_%d.json' % subset_size, symmetric_sample_ratio=0.5, thickness=2)
